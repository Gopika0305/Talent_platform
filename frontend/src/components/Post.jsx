...
const Post = ({ content,name, position,title }) => {
  ...
  <div role="status" className="max-w-[50rem] mx-96 my-8  border border-gray-200 rounded shadow md:p-6 dark:border-gray-700">
    ...
    <div className="flex font-bold aleo-regular flex-col">
    <div className="h-2.5  p-2 w-48 mb-4">
      {title}
    </div>
    <div className="h-2 mb-2.5 mx-4">
     {content}
    </div>
